...
<body>
    <div class="container">
		...
		<form class="form-horizontal" action="t_per_delete.php" method="post">
			<input type="hidden" name="id" value="<?php echo $id;?>"/>
			<p class="alert alert-error">Are you sure you want to delete ?</p>
			<div class="form-actions">
				<button type="submit" class="btn btn-danger">Yes</button>
				<a class="btn" href="t_persons.php">No</a>
			</div>
		</form>
		...
		<div class="form-horizontal" >
			...
			<div class='control-group col-md-6'>
				...
				<?php
					$pdo = Database::connect();
					$sql = "SELECT * FROM t_assign, t_tasks WHERE assign_task_id = t_task.id AND assign_per_id = " . $id . " ORDER BY task_date ASC, task_time ASC";
