...
<body>
    <div class="container">
		...
		<div class="span10 offset1">
			...
			<div class="row">
				<h3><b>Add New Person</b></h3>
			</div>
	
			<form class="form-horizontal" action="t_per_create.php" method="post" enctype="multipart/form-data">
				...
				<div class="form-actions">
					...
					<a class="w3-button w3-sand w3-round-xlarge" href="t_persons.php">Back</a>
				</div>
