...
if ( !empty($_POST)) { // if not first time through
	...
	if ($valid) 
	{
		...
		$sql = "INSERT INTO t_person (fname,lname,email,mobile,password,title,
...
<body>
    <div class="container">
		...
		<div class="span10 offset1">
			...
			<form class="form-horizontal" action="t_per_create2.php" method="post" enctype="multipart/form-data">
